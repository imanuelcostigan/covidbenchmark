...
```{r time-series, fig.width = 11, fig.height = 8, dev = c("svglite", "png")}
owid_long_tbl |> 
...
this on the most recent date for which we have data for all countries of 
interest.

```{r boxplot, fig.width = 11, fig.height = 10, dev = c("svglite", "png")}
...
owid_snaps <-
  owid_long_tbl |>
  filter(date %in% c(last_benchmark_date, benchmark_date)) |> 
